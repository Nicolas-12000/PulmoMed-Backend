...
from app.models.simulation_state import SimulationState, TeacherResponse, HealthCheckResponse
...
async def consultar_profesor(
    ...
    """
    try:
        logger.info(f"Consulta recibida - Paciente: {state.edad} años, "
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error al generar feedback educativo: {str(e)}"
        )
