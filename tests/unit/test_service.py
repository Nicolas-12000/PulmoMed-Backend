...
def mock_repository():
    ...
    repo = Mock()
    repo.retrieve_relevant_chunks = Mock(return_value=[
        {
        ...
        {
            "text": "La resección quirúrgica es el tratamiento de elección en estadios tempranos.",
...
def mock_llm_client():
    ...
    llm = Mock()
    llm.query = Mock(return_value="""**Explicación del Estado Actual:**
